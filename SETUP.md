...
| Kind | Name | Value |
|---|---|---|
| secret | `SETTLEMENT_ADDRESS_SEPOLIA` / `SETTLEMENT_PRIVATE_KEY_SEPOLIA` | Sepolia settlement account |
| secret | `SETTLEMENT_ADDRESS_MAINNET` / `SETTLEMENT_PRIVATE_KEY_MAINNET` | mainnet settlement account (needed for `network=mainnet`) |
